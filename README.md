...
For example usage, see [this notebook](https://github.com/fallcat/ares/blob/main/notebooks/exp_stability_cert_binary_synthchain3_no_repeat_10_2_no_cot_prompt1_entailment_prompt_p0.95.ipynb) for ClaimTrees.
